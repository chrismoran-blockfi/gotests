# gotests [![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](https://github.com/chrismoran-blockfi/gotests/blob/master/LICENSE) [![godoc](https://img.shields.io/badge/go-documentation-blue.svg)](https://godoc.org/github.com/chrismoran-blockfi/gotests) [![Build Status](https://github.com/chrismoran-blockfi/gotests/workflows/Go/badge.svg)](https://github.com/chrismoran-blockfi/gotests/actions) [![Coverage Status](https://coveralls.io/repos/github/cweill/gotests/badge.svg?branch=master)](https://coveralls.io/github/cweill/gotests?branch=master) [![codebeat badge](https://codebeat.co/badges/7ef052e3-35ff-4cab-88f9-e13393c8ab35)](https://codebeat.co/projects/github-com-cweill-gotests) [![Go Report Card](https://goreportcard.com/badge/github.com/chrismoran-blockfi/gotests)](https://goreportcard.com/report/github.com/chrismoran-blockfi/gotests)
...
```sh
$ go get -u github.com/chrismoran-blockfi/gotests/...
```
